<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-button type="primary" icon="el-icon-search" @click="fatchData()"
        >查询</el-button
      >
    ...
    <el-table :data="list" border style="width: 100%">
      <el-table-column fixed prop="avatar" label="头像" width="120">
...
export default {
  ...
  methods: {
    fatchData() {
      ...
      $axios({
        method: "post",
        url: `/admin/teacher/${this.page}/${this.limit}`,
